       ...
       <table id="sample-table-1" class="table table_list table_striped table-bordered dataTable no-footer">
		 <thead>
          ...
          <tr>
              ...
              <td align="center"><?php echo $v['html']; ?><?php echo $v['cat_name']?></td>
              <td align="center"><?php echo $v['parent_id']?></td>
              <td align="center"><?php echo $v['cat_desc']?></td>
              <td align="center"><?php echo $v['cat_sort']?></td>
              <td align="center">
              <a href="?r=adver/del&id=<?php echo $v['cat_id'];?>">删除</a><!-- //<a href="?r=adver/update&id=<?php echo $v['cat_id'];?>">修改</a></td> -->
     </tr>
     <?php } ?>							
		      </tbody>
	        </table>
