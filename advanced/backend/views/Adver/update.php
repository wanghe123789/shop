...
<script type="te·	xt/javascript" src="js/jquery.cookie.js"></script>
...
<body>                                               
<form action="<?php echo Url::to(['adver/add']);?>" method="post" enctype="multipart/form-data">
...
<div class="h_products_list clearfix mb20" id="Sellerber">
    ...
    <div class="list_content">
     <div class="side_list">
      <div class="left_add clearfix">
       <div class="column_title">添加分类</div>

      <ul class="add_conent">


       <li class=" clearfix"><label class="label_name"><i>*</i>分类名称：</label> <input name="cat_name" type="text" class="add_text form-control"/></li>
       <li class=" clearfix"><label class="label_name"><i>*</i>父级分类：</label>
       <select>
       	<option value="0">顶级分类</option>
       	<?php foreach ($res as $key => $v): ?>
       		<option value="<?php echo $v['cat_id'] ?>">
        		<?php echo $v['html']; ?><?php echo $v['cat_name']; ?>
        	</option>
       	<?php endforeach ?>
       </select> <!-- <input name="hao" type="text" class="add_text form-control" style="width:80px"/> --></li>
       <li class=" clearfix"><label class="label_name"><i>*</i>是否显示：</label> <input name="is_show" type="radio" class="add_text form-control" style="width:80px"/>是
       	<input name="is_show" type="radio" class="add_text form-control" style="width:80px"/>否
       </li>
       <li class=" clearfix"><label class="label_name"><i>*</i>排序：</label> <input name="cat_sort" type="text" class="add_text form-control" style="width:80px"/></li>
      <!--  <li class=" clearfix"><label class="label_name">品牌图片：</label>
           <div class="demo l_f">
	           <div class="logobox"><div class="resizebox"><img src="images/image.png" width="100px" alt="" height="100px"/ name="face"></div></div>	
         ...
         <!-- <li class=" clearfix"><label class="label_name"><i>*</i>所属地区：</label> <input name="" type="text" class="add_text" style="width:120px"/></li> -->
          <!-- <li class=" clearfix"><label class="label_name"><i>*</i>品牌头像：</label> <input name="face" type="file" class="add_text form-control" style="width:80px"/></li> -->

         <li class=" clearfix"><label class="label_name">分类描述：</label> <textarea name="cat_desc" cols="" rows="" class="textarea" onkeyup="checkLength(this);"></textarea><span class="wordage">剩余字数：<span id="sy" style="color:Red;">500</span>字</span></li>
 ...
 <input name="" type="submit"  class="btn button_btn bg-deep-blue" value="保存"/>
