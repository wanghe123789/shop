...
<form action="<?= Url::to(['product/update_do']);?>" method="post" enctype="multipart/form-data">
<body>
...
<!--   <div class="Brand_title">
 ...
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>标题名称：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="g_name" type="text"  class="col-xs-6" value="<?php echo $res['g_name']; ?>"/></div></li><input type="hidden" name="g_id" value="<?php echo $res['g_id']; ?>" />
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>简单描述：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="g_desc" type="text" class="col-xs-4" value="<?php echo $res['g_desc']; ?>"/></div></li>
   ...
   <!-- <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>关&nbsp;键&nbsp;字：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="" type="text" class="col-xs-4"/><em class="Prompt"> 请用","分隔关键字</em></div></li> -->
     ...
     <select name="cat_id" id="cat_id">
      ...
      <?php foreach ($query as $key => $val): ?>
        ...
        <option value="<?=$val['cat_id']?>" <?php if ($val['cat_id'] == $cat_id): ?>
          selected
        <?php endif ?>><?=$val['html']?><?=  $val['cat_name']?></option>  
  ...
  <li class="clearfix">
   ...
   <div class="Add_content col-xs-11">
     <span class="classification_name l_f"><label ><input type="radio" name="is_status" class="ace" value="0" 
      <?php if ($res['is_hot']==1): ?>
        checked="checked"
      <?php endif ?>
     ><span class="lbl">限时促销</span></label></span>
 
 <span class="classification_name l_f"><label ><input type="radio" name="is_status" class="ace" value="1"       <?php if ($res['is_new']==1): ?>
        checked="checked"
      <?php endif ?>><span class="lbl">新品发布</span></label></span>
  ...
  <!--  </span> -->
    ...
    <input name="g_price" type="text"  class="col-xs-7" value="<?php echo $res['g_price']; ?>" /><em class="Prompt">元</em>
    </div>   
    </div>
    <!-- <div class="col-xs-4">
   ...
   <!--  <li class="clearfix"><label class="label_name col-xs-1">设置规格：&nbsp;&nbsp;</label> 
    ...
    <div class="Add_content col-xs-9">
    <label><input type="radio" name="g_status" class="ace" checked="checked"  value="1" <?php if ($res['g_status']==1): ?>
        checked="checked"
      <?php endif ?>><span class="lbl">是</span></label>
    <label><input type="radio" name="g_status" class="ace"  value="0"
        <?php if ($res['g_status']==0): ?>
        checked="checked"
      <?php endif ?>
   ...
   <!--  <div class="col-xs-4">
    ...
    <!-- <label class="l_f checkbox_time"><input type="checkbox" name="checkbox" class="ace" checked="checked"><span class="lbl"></span></label> -->
     ...
     <div class="images_Upload clearfix margin-bottom" id="images_Upload">
      <span class="Upload_img"><input name="myfile" type="file" /></span>
      ...
      <input type="hidden" name="g_img" value="<?php echo $res['g_img']; ?>" />
      <img src="<?php echo $res['g_img']; ?>" width="100" alt="" />
    </div>
