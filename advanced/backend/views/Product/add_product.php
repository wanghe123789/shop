...
<form action="<?= Url::to(['product/add']);?>" method="post" enctype="multipart/form-data">
<body>
...
<!--   <div class="Brand_title">
 ...
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>标题名称：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="g_name" type="text"  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>简单描述：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="g_desc" type="text" class="col-xs-4"/></div></li>
   ...
   <!-- <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>关&nbsp;键&nbsp;字：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="" type="text" class="col-xs-4"/><em class="Prompt"> 请用","分隔关键字</em></div></li> -->
     ...
     <select name="cat_id" id="cat_id">
      <?php foreach ($query as $key => $val) {  ?>
        <option value="<?= $val['cat_id']?>"><?=str_repeat("|--",substr_count($val['cat_path'], "-")) ?><?=  $val['cat_name']?></option>  
      <?php } ?>
     </select>
     </div>
     </li>
  <li class="clearfix">
   ...
   <span class="classification_name l_f"><label ><input type="radio" name="is_status" class="ace" value="1"><span class="lbl">新品发布</span></label></span>
   <span class="classification_name l_f"><label ><input type="radio" name="is_status" class="ace" value="0"><span class="lbl">限时促销</span></label></span>
  ...
  <!--  </span> -->
    ...
    <input name="g_price" type="text"  class="col-xs-7"/><em class="Prompt">元</em>
    </div>   
    </div>
    <!-- <div class="col-xs-4">
   ...
   <!--  <li class="clearfix"><label class="label_name col-xs-1">设置规格：&nbsp;&nbsp;</label> 
    ...
    <div class="Add_content col-xs-9">
    <label><input type="radio" name="g_status" class="ace" checked="checked"  value="1"><span class="lbl">是</span></label>
    <label><input type="radio" name="g_status" class="ace"  value="0"><span class="lbl">否</span></label>
    </div>   
    </div>
    类型：
