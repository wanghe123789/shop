...
<body>                                               
<form action="<?php echo Url::to(['brand/add_do']);?>" method="post" enctype="multipart/form-data">
    ...
    <div class="list_content">
     <div class="side_list">
      ...
      <ul class="add_conent">
       ...
       <li class=" clearfix"><label class="label_name"><i>*</i>品牌名称：</label> <input name="name" type="text" class="add_text form-control"/></li>
       <li class=" clearfix"><label class="label_name"><i>*</i>品牌序号：</label> <input name="hao" type="text" class="add_text form-control" style="width:80px"/></li>
      <!--  <li class=" clearfix"><label class="label_name">品牌图片：</label>
         ...
         <li class=" clearfix"><label class="label_name">品牌描述：</label> <textarea name="discribe" cols="" rows="" class="textarea" onkeyup="checkLength(this);"></textarea><span class="wordage">剩余字数：<span id="sy" style="color:Red;">500</span>字</span></li>
