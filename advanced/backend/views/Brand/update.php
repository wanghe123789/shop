...
<body>
<form action="<?php echo Url::to(['brand/update_do']);?>" method="post" enctype="multipart/form-data">
...
<div class="h_products_list clearfix mb20" id="Sellerber">
    ...
    <div class="list_content">
     <div class="side_list">
      ...
      <ul class="add_conent">
       ...
       <li class=" clearfix"><label class="label_name"><i>*</i>品牌名称：</label> <input name="name" type="text"  value="<?php echo $posts['name']?>" class="add_text form-control"/></li>
       <li class=" clearfix"><label class="label_name"><i>*</i>品牌序号：</label> <input name="hao" type="text" value="<?php echo $posts['hao']?>" class="add_text form-control" style="width:80px"/></li>
      <!--  <li class=" clearfix"><label class="label_name">品牌图片：</label>
         ...
         <!-- <li class=" clearfix"><label class="label_name"><i>*</i>所属地区：</label> <input name="" type="text" class="add_text" style="width:120px"/></li> -->
          <li class=" clearfix"><label class="label_name"><i>*</i>品牌头像：</label>  <img src="<?php echo $posts['face']?>" width=100 height=80><input name="face" type="file" class="add_text form-control" style="width:80px"/></li>

         <li class=" clearfix"><label class="label_name">品牌描述：</label> <textarea name="discribe" cols="" rows="" class="textarea" onkeyup="checkLength(this);"><?php echo $posts['discribe']?></textarea><span class="wordage">剩余字数：<span id="sy" style="color:Red;">500</span>字</span></li>
 ...
 <input type="submit"  class="btn button_btn bg-deep-blue" value="保存"/>
 <input type="reset" value="取消" class="btn button_btn btn-Dark-success"/>
</div>
</div>
</form>
</body>
