	...
	<div class="member-center clearfix">
		...
		<div class="member-right fr">
			<div class="member-head">
				<div class="member-heels fl"><h2>收货地址</h2></div>
			</div>
			...
			<form action="">
				...
				<tr>
					<td><?php echo $v['address']?><br/></td>
					<td><?php echo $v['user_name']?><br/></td>
					<td><?php echo $v['user_tel']?><br/></td>
					<td><a href="?r=address/del&id=<?php echo $v['address_id'];?>">删除</a> ||
					    <a href="?r=address/update&id=<?php echo $v['address_id'];?>">修改</a><br/></td>
				</tr>
				<?php }  ?>
			</form></table>
				</div>
