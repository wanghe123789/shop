		...
		<div class="containers">
			...
			<div class="time-lists clearfix">
				<div class="time-list time-list-w fl" style="width:1156px">
					<div class="time-title time-clear"><div class="pc-font fl"></div><a href="javascript:;" class="pc-spin fr"></a> </div>
								...
								<div class="yScrollListInList yScrollListInList1" style="display:block;">
									...
									<?php foreach ($res as $key => $value): ?>
										...
										<li  style="float:left;display:inline;">
											<a href="index.php?r=goods/detail&g_id=<?php echo $value['g_id']?>">
												<img src="<?php echo $value['g_img']; ?>">
												<p class="head-name pc-pa10"><?php echo $value['g_name']; ?></p>
